...
public class LLLLGGSbatchEntryPoint {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		int maxIndex = Math.min(minIndex + batchsize, localgridsize*localgridsize + globalgridsize*(globalgridsize+1)/2);
		...
		LLLLGGBestResponse.main(minIndex, maxIndex, configfile, strategyFile, outputFolder, state);
	}
}
